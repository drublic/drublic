...
If you’ve followed my recent posts on [Vibe Coding](/blog/from-vibe-coding-agentic-engineering) and the [LLM benchmark wars](/blog/ai-coding-benchmark-gpt-5-1-gemini-3-opus-4-5), you know I’m obsessed with the transition from AI as a "text-box" to AI as an "agent." To truly test the limits of agentic workflows, I decided to apply these patterns to a domain where data is messy, feedback loops are physical, and precision is everything: Endurance Coaching.
...
In my recent writing, I've discussed the shift from [Vibe Coding to Agentic Engineering](/blog/from-vibe-coding-agentic-engineering). This same paradigm shift is happening in sports science. We are moving away from "software as a tool" and toward "software as an agent."

That is why I am building [N+One](https://nplusone.app/).
