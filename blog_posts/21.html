{"title":"Effects for the Web!","permalink":"effects-for-the-web","author":"Christian \"Schepp\" Schaefer","authorUrl":"","categories":["CSS","Design","HTML5","Internet Explorer"],"tags":["CSS3","Design","Filters","internet explorer","SVG","Webkit"],"headline":"Effects for the Web!","metaTags":"","metaDescription":"","date":"2011-12-27"}
							...
							<div class="message">
				<h3>Hey there…</h3>
				<p>This post is 547 days old. It was written on 27.12.2011. Please make sure to be careful with the information provided and check a more recent source on this topic.</p>
			</div>
		
		<p><strong>Christian “Schepp” Schaefer shows how to use the new filter-properties for CSS3 and combine them with methods implemented by most modern browsers. This article was <a href="http://maddesigns.de/css3-filter-1525.html" target="_blank">first published</a> in German on December 19th 2011.</strong></p>
