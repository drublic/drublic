{"title":"About The CSS Hierarchies Module Level 3","permalink":"the-css-hierarchies-module-level-3","author":"Hans Christian","authorUrl":"","categories":["CSS","CSS WDs","Research"],"tags":["CSS","CSS3","Preprocessors","Research","Specification"],"headline":"About The CSS Hierarchies Module Level 3","metaTags":"","metaDescription":"","date":"2012-02-17"}
							...
							<div class="message">
				<h3>Hey there…</h3>
				<p>This post is 495 days old. It was written on 17.02.2012. Please make sure to be careful with the information provided and check a more recent source on this topic.</p>
			</div>
		
		<p>Since the beginning of February there were some proposals for the CSS3 specification. These proposals are not yet part of the&nbsp;specification&nbsp;and will likely be changed until they get adopted by the <a title="The CSS Working Group Wiki" href="http://wiki.csswg.org/">CSSWG</a>. One of these drafts is the&nbsp;<a title="The CSS Hierarchies Module Level 3" href="http://dev.w3.org/csswg/css3-hierarchies/"><strong>CSS Hierarchies Module Level 3</strong></a>.</p>
...
<p>~ <a title="Status" href="http://dev.w3.org/csswg/css3-hierarchies/#status">CSS Hierarchies Module – Status</a></p></blockquote>
<h2>Opinion</h2>
